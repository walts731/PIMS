...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add_fuel_out') {
        ...
        header('Location: ../fuel_dashboard.php?tab=fuelout');
        exit();
    }
}
...
function viewTransaction(transactionId) {
    fetch('fuel_tabs/get_transaction.php?id=' + transactionId)
        ...
        .then(data => {
            const detailsHtml = `
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-6">${new Date(data.transaction_date).toLocaleString()}</div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Type:</strong></div>
                    <div class="col-6"><span class="badge bg-danger text-white">${data.transaction_type}</span></div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Fuel Type:</strong></div>
                    <div class="col-6">${data.fuel_type}</div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Quantity:</strong></div>
                    <div class="col-6">${data.quantity} Liters</div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Tank:</strong></div>
                    <div class="col-6">${data.tank_number || 'N/A'}</div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Vehicle/Equipment:</strong></div>
                    <div class="col-6">${data.vehicle_equipment}</div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Driver:</strong></div>
                    <div class="col-6">${data.driver_name || 'N/A'}</div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Department:</strong></div>
                    <div class="col-6">${data.department || 'N/A'}</div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Purpose:</strong></div>
                    <div class="col-6">${data.purpose}</div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Odometer:</strong></div>
                    <div class="col-6">${data.odometer_reading || 'N/A'}</div>
                </div>
                <div class="row mt-2">
                    <div class="col-6"><strong>Created By:</strong></div>
                    <div class="col-6">User ID: ${data.user_id}</div>
                </div>
            `;
...
function deleteTransaction(transactionId) {
    if (confirm('Are you sure you want to delete this transaction? This action cannot be undone.')) {
        fetch('fuel_tabs/delete_transaction.php', {
            method: 'POST',
            headers: {
