...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add_fuel_in') {
        ...
        header('Location: ../fuel_dashboard.php?tab=fuelin');
        exit();
    }
}
        ...
        .then(data => {
            const detailsHtml = `
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-6"><span class="badge bg-success text-white">${data.transaction_type}</span></div>
                </div>
                <div class="row mt-2">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-6">${data.supplier || 'N/A'}</div>
                </div>
                <div class="row mt-2">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-6">${data.vehicle_equipment || 'N/A'}</div>
                </div>
                <div class="row mt-2">
