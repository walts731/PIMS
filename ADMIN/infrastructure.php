    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h1 class="mb-2">
                        <i class="bi bi-building"></i> Infrastructure Management
                    </h1>
                ...
                <div class="col-md-6 text-md-end">
                    ...
                    <button class="btn btn-infrastructure ms-2" data-bs-toggle="modal" data-bs-target="#addInfrastructureModal">
        ...
        <div class="row mb-4">
            <div class="col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-label">Total Infrastructure</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stats-card">
                    <div class="stats-number">₱<?php echo number_format($total_value, 2); ?></div>
                    <div class="stats-label">Total Acquisition Cost</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stats-card">
        ...
        <div class="filter-card no-print">
            ...
            <form method="GET" action="infrastructure.php">
                <div class="row">
                    <div class="col-md-4">
