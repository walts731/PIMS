                ...
                <div class="col-md-4 text-md-end">
                    <div class="d-flex gap-2 justify-content-md-end flex-column">
                        <div class="search-box">
                            ...
                            <input type="text" id="searchInput" class="form-control" placeholder="Search ICS forms...">
                        </div>
                        <div class="d-flex gap-2">
                            <a href="ics_form.php" class="btn btn-primary btn-sm">
                                <i class="bi bi-plus-circle"></i> New ICS
                            </a>
                            <button class="btn btn-success btn-sm" onclick="exportICSData()">
        ...
        <div class="row g-3 mb-4">
            <div class="col-6 col-md-3">
                <div class="stats-card">
                    ...
                    <div class="stats-label"><i class="bi bi-file-earmark-text"></i> Total ICS Forms</div>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="stats-card">
