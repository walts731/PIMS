                        ...
                        <div style="border: 1px solid #dee2e6; padding: 20px; border-radius: 8px; background-color: #f8f9fa;">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="accountable_officer" value="<?php echo $latest_iirup ? htmlspecialchars($latest_iirup['accountable_officer']) : ''; ?>" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label" style="font-weight: normal; margin-bottom: 5px;">Designation:</label>
                                    <input type="text" class="form-control" name="designation" value="<?php echo $latest_iirup ? htmlspecialchars($latest_iirup['designation']) : ''; ?>" required>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="department_office" required>
                                        ...
                                        if ($offices_result) {
                                            while ($office = $offices_result->fetch_assoc()) {
                                                $selected = ($latest_iirup && $latest_iirup['department_office'] === $office['office_name']) ? 'selected' : '';
                                                echo '<option value="' . htmlspecialchars($office['office_name']) . '" ' . $selected . '>' . htmlspecialchars($office['office_name']) . '</option>';
                                            }
                                        }
                                        ?>
                                    </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="signature-block">
                            <input type="text" class="form-control form-control-sm mb-2" name="accountable_officer_name" placeholder="Signature over Printed Name of Accountable Officer" value="<?php echo $latest_iirup ? htmlspecialchars($latest_iirup['accountable_officer_name']) : ''; ?>">
                            <input type="text" class="form-control form-control-sm mb-2" name="accountable_officer_designation" placeholder="Designation of Accountable Officer" value="<?php echo $latest_iirup ? htmlspecialchars($latest_iirup['accountable_officer_designation']) : ''; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <p>Approved by:</p>
                        <div class="signature-block">
                            <input type="text" class="form-control form-control-sm mb-2" name="authorized_official_name" placeholder="Signature over Printed Name of Authorized Official" value="<?php echo $latest_iirup ? htmlspecialchars($latest_iirup['authorized_official_name']) : ''; ?>">
                            <input type="text" class="form-control form-control-sm mb-2" name="authorized_official_designation" placeholder="Designation of Authorized Official" value="<?php echo $latest_iirup ? htmlspecialchars($latest_iirup['authorized_official_designation']) : ''; ?>">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="signature-block">
                            <input type="text" class="form-control form-control-sm mb-2" name="inspection_officer_name" placeholder="Signature over Printed Name of Inspection Officer" value="<?php echo $latest_iirup ? htmlspecialchars($latest_iirup['inspection_officer_name']) : ''; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <p>I CERTIFY that I have witnessed disposition of articles enumerated on this report this _____ day of _____.</p>
                        <div class="signature-block">
                            <input type="text" class="form-control form-control-sm mb-2" name="witness_name" placeholder="Signature over Printed Name of Witness" value="<?php echo $latest_iirup ? htmlspecialchars($latest_iirup['witness_name']) : ''; ?>">
                        </div>
                    </div>
                </div>
            </div>
