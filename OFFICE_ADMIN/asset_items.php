...
$asset_stmt->bind_param("ii", $asset_id, $_SESSION['office_id']);
$asset_stmt->execute();
...
// Get asset items for this office
$items = [];
$items_sql = "SELECT ai.* FROM asset_items ai WHERE ai.asset_id = ? AND ai.office_id = ? ORDER BY ai.id";
$items_stmt = $conn->prepare($items_sql);
$items_stmt->bind_param("ii", $asset_id, $_SESSION['office_id']);
$items_stmt->execute();
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-md-end">
                    <a href="office_assets.php" class="btn btn-back me-2">
