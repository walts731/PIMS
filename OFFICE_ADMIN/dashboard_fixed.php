...
<!-- Fixed Notification Script -->
<script>
document.addEventListener('DOMContentLoaded', function() {
    console.log('Fixed dashboard loaded - initializing notifications...');
    ...
    // Override the existing notification functions with clean versions
    ...
    if (notificationDropdown && notificationList) {
        // Remove existing listeners and add clean one
        notificationDropdown.removeEventListener('click', loadNotifications);
    ...
    console.log('Fixed notification system initialized');
});
