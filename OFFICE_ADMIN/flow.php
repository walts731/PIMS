...
<script>
<script>
        // Debugging code to analyze current state
        function debugElements() {
            console.log("=== DEBUGGING OCEAN AND BOAT ===");
            
            // Check ocean container
            const oceanContainer = document.querySelector(".ocean-container");
            if (oceanContainer) {
                const oceanStyles = window.getComputedStyle(oceanContainer);
                console.log("Ocean Container:", {
                    exists: true,
                    position: oceanStyles.position,
                    bottom: oceanStyles.bottom,
                    width: oceanStyles.width,
                    height: oceanStyles.height,
                    overflow: oceanStyles.overflow,
                    zIndex: oceanStyles.zIndex
                });
            } else {
                console.log("Ocean Container: NOT FOUND");
            }
            
            // Check boat
            const boat = document.querySelector(".boat");
            if (boat) {
                const boatStyles = window.getComputedStyle(boat);
                console.log("Boat:", {
                    exists: true,
                    ...
                    transform: boatStyles.transform
                });
            } else {
        ...
        function addVisualDebug() {
            // Add debug border to ocean container
            const oceanContainer = document.querySelector(".ocean-container");
            if (oceanContainer) {
                oceanContainer.style.border = "3px solid red";
                oceanContainer.style.backgroundColor = "rgba(255, 0, 0, 0.1)";
            }
            
            // Add debug border to boat
            const boat = document.querySelector(".boat");
            if (boat) {
                boat.style.border = "2px solid blue";
                boat.style.backgroundColor = "rgba(0, 0, 255, 0.1)";
            }
            
            // Add debug borders to waves
            const waves = document.querySelectorAll(".wave");
            waves.forEach((wave, index) => {
                wave.style.border = "1px solid green";
                wave.style.backgroundColor = `rgba(0, 255, 0, ${0.1 + index * 0.05})`;
            });
        }
        
        window.addEventListener("load", addVisualDebug);
        ...
        window.addEventListener(\"scroll\", function() {
            ...
            const boat = document.querySelector(\".boat\");
            const boatStartLeft = 15;
            const boatEndLeft = 85;
